      ...
      {hasData ? (
        <>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-2">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Status: {status}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400">Criado em: {new Date(date).toLocaleDateString()}</p>
          </div>
        </>
      ) : (
        <>
          <p className="text-3xl font-bold text-center mb-4 text-gray-900 dark:text-gray-100">Sem dados</p>
          <div className="border-t border-gray-200 dark:border-gray-700 pt-2">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Status: Não disponível</p>
            <p className="text-sm text-gray-600 dark:text-gray-400">Data não disponível</p>
          </div>
        </>
      )}
    </div>
